...
class MainViewModel(context: Context): ViewModel() {
    ...
    private val _usageLevel : MutableLiveData<String> = MutableLiveData(context.getString(R.string.usage_level))
    ...
    private val _installButtonName : MutableLiveData<String> = MutableLiveData(context.getString(R.string.installButton_name))
